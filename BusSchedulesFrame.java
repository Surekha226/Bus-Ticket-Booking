...
public class BusSchedulesFrame extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        backButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        ...
        backButton.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 2),  // Changed from WHITE to BLACK
    ...
    private JPanel createTopPanel() {
        ...
        busLabel.setForeground(Color.BLACK);  // Changed to BLACK
        panel.add(busLabel);
        ...
        refreshButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        ...
        refreshButton.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 2),  // Changed from green to black
            BorderFactory.createEmptyBorder(5, 10, 5, 10)
        ));
    ...
    private JPanel createTablePanel() {
        ...
        schedulesTable.setForeground(Color.BLACK);
        ...
        schedulesTable.getTableHeader().setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createFormPanel() {
        ...
        dateField.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 1),  // Changed from GRAY to BLACK
        ...
        dateHint.setForeground(Color.BLACK);  // Changed from GRAY to BLACK
        gbc.gridx = 2;
        ...
        timeHint.setForeground(Color.BLACK);  // Changed from GRAY to BLACK
        gbc.gridx = 2;
        ...
        arrivalTimeField.setForeground(Color.BLACK);
        ...
        JLabel arrHint = new JLabel("(HH:MM:SS)");
        arrHint.setFont(new Font("Arial", Font.ITALIC, 12));
        arrHint.setForeground(Color.BLACK);  // Changed from GRAY to BLACK
        gbc.gridx = 2;
        panel.add(arrHint, gbc);
        ...
        availableSeatsField.setForeground(Color.BLACK);
        ...
        recurringCheck.setForeground(Color.BLACK);
    ...
    private JButton createButton(String text, Color color) {
        ...
        button.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 2),  // Changed from color.darker() to BLACK
            BorderFactory.createEmptyBorder(5, 10, 5, 10)
        ));
