...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        // Login Button - Changed text to BLACK for better visibility
        ...
        // Sign Up Button - Changed text to BLACK for better visibility
        JButton signupButton = new JButton("Sign Up");
        signupButton.setBackground(new Color(52, 152, 219));
        signupButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        ...
        // Admin Button - Changed text to BLACK for better visibility
        JButton adminButton = new JButton("Admin");
        adminButton.setBackground(new Color(155, 89, 182)); // Purple
        adminButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
