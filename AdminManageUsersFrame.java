...
public class AdminManageUsersFrame extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        backButton.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 1),  // Changed to black border
    ...
    private JPanel createSearchPanel() {
        ...
        searchButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createTablePanel() {
        ...
        resetPasswordButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        ...
        deleteButton.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
