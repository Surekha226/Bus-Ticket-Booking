...
public class AdminReportsFrame extends JFrame {
    ...
    private JTabbedPane createTabbedPane() {
        ...
        tabbedPane.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createPopularBusesPanel() {
        ...
        popularBusesTable.setForeground(Color.BLACK);
        ...
        popularBusesTable.getTableHeader().setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createUserActivityPanel() {
        ...
        activeUsersTable.setForeground(Color.BLACK);
        ...
        activeUsersTable.getTableHeader().setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createRevenuePanel() {
        ...
        chartLabel.setForeground(Color.BLACK);  // Changed from GRAY to BLACK
    ...
    private JPanel createStatCard(String title, JLabel valueLabel, Color color) {
        ...
        valueLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        
        JLabel titleLabel = new JLabel(title, SwingConstants.CENTER);
        titleLabel.setFont(new Font("Arial", Font.BOLD, 12));
        titleLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
    ...
    private JPanel createRevenueCard(String period, JLabel amountLabel, Color color) {
        JPanel card = new JPanel(new BorderLayout());
        card.setBackground(color);
        card.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));  // Changed from WHITE to BLACK
        card.setOpaque(true);
        
        JLabel periodLabel = new JLabel(period, SwingConstants.CENTER);
        periodLabel.setFont(new Font("Arial", Font.BOLD, 14));
        periodLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
        
        amountLabel.setFont(new Font("Arial", Font.BOLD, 18));
        amountLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK
