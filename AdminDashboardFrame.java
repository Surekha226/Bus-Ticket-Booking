...
public class AdminDashboardFrame extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        logoutButton.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 2),  // Changed border to black
    ...
    private JPanel createButtonPanel() {
        ...
        // Create buttons with solid colors - text color changed to BLACK
    ...
    private JButton createSolidButton(String text, Color bgColor) {
        ...
        button.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Color.BLACK, 4),  // Changed border to black
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                button.setBorder(BorderFactory.createCompoundBorder(
                    BorderFactory.createLineBorder(Color.WHITE, 4),  // Hover border remains white
                    BorderFactory.createEmptyBorder(15, 15, 15, 15)
                ));
            ...
            public void mouseExited(MouseEvent e) {
                button.setBackground(bgColor);
                button.setBorder(BorderFactory.createCompoundBorder(
                    BorderFactory.createLineBorder(Color.BLACK, 4),  // Changed back to black border
                    BorderFactory.createEmptyBorder(15, 15, 15, 15)
                ));
                button.setForeground(Color.BLACK);  // Keep text black
            }
        });
    ...
    private JPanel createStatCard(String title, String value, Color color) {
        ...
        valueLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK for better visibility
        
        JLabel titleLabel = new JLabel(title, SwingConstants.CENTER);
        titleLabel.setFont(new Font("Arial", Font.BOLD, 14));
        titleLabel.setForeground(Color.BLACK);  // Changed from WHITE to BLACK for better visibility
